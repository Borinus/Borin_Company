...
| | |
|---|---|
| Horas realmente disponíveis por semana | [ ] |
| Semanas por mês | 4 |
| **Horas produtivas por mês** | **[ ]** |

Descontar 20% dessas horas para proposta, cobrança, conversa com cliente e retrabalho. O que sobra é
a hora faturável.
...
Cronometrar os próximos projetos. Sem esse dado, orçamento é chute.

| Escopo | Horas estimadas | Base |
|---|---|---|
| Escopo A — painel pequeno (até ~30 I/Os) | [ ] | |
| Escopo A — painel médio (~30 a 80 I/Os) | [ ] | |
| Escopo A — painel grande (acima de 80 I/Os) | [ ] | |
| Escopo B — acréscimo da instalação | [ ] | |

**Anote o tempo real de cada projeto entregue.** Depois de três projetos você para de chutar.
...
*A preencher depois de cronometrar os primeiros projetos.*

| Serviço | Unidade | Valor |
|---|---|---|
| Escopo A — painel pequeno | projeto | R$ [ ] |
| Escopo A — painel médio | projeto | R$ [ ] |
| Escopo A — painel grande | projeto | R$ [ ] |
...
| | |
|---|---|
| Revisões inclusas | 2 rodadas após a primeira emissão |
| O que conta como escopo novo | Qualquer coisa fora da premissa registrada no briefing |
| Prazo padrão | [ ] dias úteis, do sinal |
