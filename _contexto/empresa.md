...
**Ferramentas:** EPLAN Electric Pro Panel, Excel, Claude Code. Também usa Python e Node.js em automações pontuais. LOGO! Soft Comfort V8 (Siemens) no aprendizado de CLP
...
implantando o padrão EPLAN lá. O negócio próprio é paralelo e está sendo estruturado agora.
...
**Nível:** avançado em EPLAN (cria projetos completos e define padrão). Iniciante em programação de CLP.
